...
ALLOWED_HOSTS = ["newsnow.pythonanywhere.com"]
CSRF_TRUSTED_ORIGINS = ["https://newsnow.pythonanywhere.com"]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'MS_m6pqdC@trial-3vz9dlez1jqlkj50.mlsender.net'  # Your email address
EMAIL_HOST_PASSWORD = 'nlEtXB4BXW9N6LPI'       # Your email password
